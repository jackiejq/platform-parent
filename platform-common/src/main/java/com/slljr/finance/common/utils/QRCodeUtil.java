...
public class QRCodeUtil {
    ...
    public static BufferedImage createQRCode(String content) throws WriterException {
        ...
        BitMatrix matrix = WRITER.encode(content, BarcodeFormat.QR_CODE, QRCODE_WIDTH, QRCODE_WIDTH);
    ...
    public static BufferedImage createQRCode(String content, int width) throws WriterException {
        ...
        BitMatrix matrix = WRITER.encode(
                content, BarcodeFormat.QR_CODE, width, width);
        return toBufferedImage(matrix);
    }
     ...
     * @throws WriterException
     */
    public static BufferedImage createQRCodeWithIcon(String content, String iconPath) throws WriterException {
        BitMatrix matrix = WRITER.encode(
     ...
     * @throws IOException
     */
    public static BufferedImage createBarCode(String content) throws WriterException, IOException {
     ...
     * @version 1.0
     */
    public static BufferedImage createQrCodeWithCustomizeMargin(String content, int margin) throws WriterException {
        // 长和宽一样，所以只需要定义一个SIZE即可
        BitMatrix matrix = WRITER.encode(content, BarcodeFormat.QR_CODE, QRCODE_WIDTH, QRCODE_WIDTH);
        //删除白边重新绘制
        BitMatrix resultMatrix = reduceWhite(matrix, margin);
        //转换BufferedImage
        return toBufferedImage(resultMatrix);
    }
     ...
     * @version 1.0
     */
    public static BufferedImage createQrCodeWithCustomizeMargin(String content, int width, int margin) throws WriterException {
        // 长和宽一样，所以只需要定义一个SIZE即可
    ...
    public static void main(String[] args) throws Exception {
        ...
        File qrCode = new File("D:\\1000103." + FORMAT);
        File qrCodeWithIcon = new File("D:\\1000103." + FORMAT);
        // 生成二维码
        writeToFile(createQrCodeWithCustomizeMargin(content, 5), qrCode);
        BufferedImage image = QRCodeUtil.createQrCodeWithCustomizeMargin(content, 5);
        ImageIO.write(image, "jpg", new File("D:\\1000103.jpg"));
        // 生成带图标的二维码
