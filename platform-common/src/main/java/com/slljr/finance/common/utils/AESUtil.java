...
//			
//			String miwen = AESUtil.ecodes(mapStr, "quanran");
//			System.out.println(miwen);
//			
//			String mingwen = AESUtil.dcodes(miwen, "quanran");
