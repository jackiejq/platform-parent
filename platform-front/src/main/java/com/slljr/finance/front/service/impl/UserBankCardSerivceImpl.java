...
// */
//@Service
//public class UserBankCardSerivceImpl implements UserBankCardSerivce {
//
...
//		//查询用户下信用卡
//		List<UserBankCardDetailVo> obj = userBankCardMapper.findByUidAndInfo(record);
//
//		for (UserBankCardDetailVo userBankCardDetailVo : obj) {
//			//查询当前用户当前卡信息
//			UserBankCard searchParam = new UserBankCard();
//			searchParam.setUid(uid);
//			searchParam.setId(userBankCardDetailVo.getId());
//			//还款中比数
//			UserBankCardDetailVo ub = userBankCardMapper.numberPayments(searchParam);
//			userBankCardDetailVo.setNumberPayments(ub.getNumberPayments());
//			//查询总代偿金额
//			UserBankCardDetailVo ubc = userBankCardMapper.totalCompensationAmount(searchParam);
//			userBankCardDetailVo.setTotalCompensationAmount(ubc.getTotalCompensationAmount());
//			//已还总金额
//			UserBankCardDetailVo ubcd = userBankCardMapper.totalAmountRepaid(searchParam);
//			userBankCardDetailVo.setTotalAmountRepaid(ubcd.getTotalAmountRepaid());
//		}
//
//		long endTime = System.currentTimeMillis();
//
//		log.info("====UserBankCardSerivceImpl.queryCreditCardInfo统计耗时(毫秒)===={}", startTime - endTime);
//
//		return obj;
//	}
//
